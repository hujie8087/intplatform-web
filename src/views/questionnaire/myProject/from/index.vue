  ...
  <div class="form-index-container">
    <el-card class="header-container">
      <el-row align="middle" type="flex" :gutter="5">
        ...
        <img class="header-logo" src="@/assets/images/logo.png" @click="$router.push({ path: '/' })" />
        <el-col />
        <el-button type="primary" icon="el-icon-view" @click="previewDialogVisible = true"> 预览 </el-button>
        <el-button type="success" icon="el-icon-folder-add" @click="saveProjectAsTemplateHandle"> 保存为模板 </el-button>
      </el-row>
    </el-card>
    ...
    <el-dialog v-model:visible="previewDialogVisible" destroy-on-close fullscreen>
...
export default {
  ...
  methods: {
    ...
    saveProjectAsTemplateHandle() {
      this.$api.post("/user/project/template/save", { projectKey: this.projectKey }).then(() => {
