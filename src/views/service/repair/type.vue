    ...
    <div class="table-box">
      ...
      >
        ...
        <template #tableHeader="scope">
          <el-button type="primary" :icon="CirclePlus" v-auth="['repair:type:add']" @click="openDrawer('新增')"
            >新增维修类型</el-button
          >
          <el-button
            type="danger"
            :disabled="!scope.isSelected"
            v-auth="['repair:type:remove']"
            :icon="Delete"
        ...
        <template #operation="scope">
          ...
          <el-button
            ...
            :icon="EditPen"
            v-auth="['repair:type:edit']"
            @click="openDrawer('编辑', scope.row)"
          >
            编辑
          </el-button>
          <el-button type="danger" link :icon="Delete" v-auth="['repair:type:remove']" @click="deleteRepairTypeHandle(scope.row)"
            >删除</el-button
          >
        </template>
      </ProTable>
