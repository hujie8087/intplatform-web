<template>
  <div>
    <el-form>
      ...
      <el-form-item>
        <el-radio v-model="radioValue" :value="4" style="float: left; margin-right: 10px">指定</el-radio>
        <el-select
          clearable
...
const onRadioChange = () => {
  switch (radioValue.value) {
    case 1:
      localCron.value.second = "*";
      break;
    case 2:
      localCron.value.second = cycleTotal.value;
      break;
    case 3:
      localCron.value.second = averageTotal.value;
      break;
    case 4:
      ...
      localCron.value.second = checkboxString.value;
      break;
  }
};
</script>
