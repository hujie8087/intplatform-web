...
interface DrawerProps {
  title: string;
  isView: boolean;
  rowData: Partial<WaterSettlement.ResWaterSettlement>;
...
const selectedOrder = ref<WaterSettlement.ResWaterSettlement[]>([]);
const handleSelectOrder = () => {
  selectedOrder.value = orderTableRef.value!.selectedList as WaterSettlement.ResWaterSettlement[];
